...
<body>
	...
	<div class="row" style="">
        <div class="float_left">
            <table>
                <thead>
                 ...
                 <tr>
                    <td colspan="2">
                        <b style="font-size:1.2em;">{{$student->surname .','.' '.$student->firstname. ' '.$student->othername}}
                        </b></td>
                </tr>
		...
		<div class="row p">
            ...
            Calabar, Nigeria. The candidtate is / was of the Department of <b>{{$student->Department->name}} </b> in the Faculty/College/Institute of <b>{{$student->Faculty->name}}.</b>
        </p>
    <p>The transcript is herewith enclosed. You will have to satisfy yourself that<b> {{$student->surname .', '.$student->firstname. ' '.$student->othername}}</b>
