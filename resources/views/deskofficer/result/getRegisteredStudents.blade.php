                ...
                <div class="col-lg-12">
                        <div class="p-5">
                          <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Registered Students</h1>
                          </div>
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('getRegisteredStudents') }}" >
                                {{ csrf_field() }}
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="col-3" ><b>Present Session : </b>{{$session. ' / '.$next_session}} </div>
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                  <a href="{{url('resultDetails',[$item->id,$level,$session,$period])}}" target="_blank" class="btn btn-primary btn-circle btn-sm ">
